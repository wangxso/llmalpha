"""
OpenAI Provider for LLM Alpha.

Implements connection to OpenAI GPT models.
"""
...
class OpenAIProvider(LLMProvider):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Support custom base_url for third-party proxies
    ...
    async def complete_stream(
        ...
        **kwargs,
        ...
        """
        Send messages to OpenAI with streaming output.
        Supports optional token callback for immersive UI.
        Hides code blocks and shows "正在编写代码..." instead (when not using callback).
        """
